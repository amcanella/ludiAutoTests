...
#       asyncio.run(main(addr, command_list[i]))
    ...
    startend= [[0,math.inf],[0, 1.5], [-8388608, 8388608], [-8388608, 8388608], [-8388608, 8388608],[-8388608, 8388608],[5000000, 9000000 ],[-1000000,1000000], [975,995], [0,60], [0,100], [975,995], [0,60], [0,100],[975,995], [0,60], [0,100],[-40,100]] #dont need to be accurate ranges, only make sense, i.e. 1080 for forced exhalation
