# -*- coding: utf-8 -*-
"""
Created on Mon Oct 10 12:34:53 2022
...
def notification_handler2(sender, data):
     ...
     mouthpiece = data_sensors[4:5]
     Co2 = data_sensors[5:8]
     Co2_1 = data_sensors[8:11]
     Co2_2 = data_sensors[11:14]
     Co2_3 = data_sensors[14:17]
     o2 = data_sensors[17:20]
     No2 = data_sensors[20:23]
     Pressure = data_sensors[23:27]
     Temp = data_sensors[27:31]
     Hum = data_sensors[31:35]
     Pressure_1 = data_sensors[35:39]
     Temp_1 = data_sensors[39:43]
     Hum_1 = data_sensors[43:47]
     Pressure_2 = data_sensors[47:51]
     Temp_2 = data_sensors[51:55]
     Hum_2 = data_sensors[55:59]
     bat = data_sensors[59:63]
     ...
     # NOT ABLE TO UNPACK THREEE BYTES ONLYYYY https://docs.python.org/3/library/struct.html#struct.pack_into
...
#       asyncio.run(main(addr, command_list[i]))
    ...
    startend= [[0,math.inf],[0, 1.5], [-8388608, 8388608], [-8388608, 8388608], [-8388608, 8388608],[-8388608, 8388608],[5000000, 9000000 ],[-8388608, 8388608], [970,998], [0,60], [0,100], [970,998], [0,60], [0,100],[970,998], [0,60], [0,100],[-40,100]] #dont need to be accurate ranges, only make sense, i.e. 1080 for forced exhalation
